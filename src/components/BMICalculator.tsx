...
const BMICalculator = () => {
  ...
  const handleCalculate = () => {
    ...
    if (
      (isMetricHeight && heightCm > 250) || 
      (!isMetricHeight && (heightFeet > 8 || (heightFeet === 8 && heightInches > 0))) ||
      (isMetricWeight && weightKg > 250) || 
      (!isMetricWeight && weightLbs > 550)
    ) {
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center mb-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Switch 
                  checked={!isMetricHeight} 
                  onCheckedChange={() => setIsMetricHeight(!isMetricHeight)}
                />
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center mb-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Switch 
                  checked={!isMetricWeight} 
                  onCheckedChange={() => setIsMetricWeight(!isMetricWeight)}
                />
            ...
            <div className="flex space-x-2">
              <div className="w-full">
                <Input
                  id="weight"
                  type="number"
                  value={isMetricWeight ? weightKg : weightLbs}
                  onChange={(e) => {
                    if (isMetricWeight) {
          ...
          {bmi !== null && !error && (
            <div className="space-y-4">
              ...
              <BMIResultBar 
                ...
                category={category}
                visible={visible}
                heightInCm={isMetricHeight ? heightCm : (heightFeet * 30.48 + heightInches * 2.54)} 
              />
