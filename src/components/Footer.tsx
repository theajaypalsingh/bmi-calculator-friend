      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <ul className="space-y-2">
              {links.map(link => <li key={link.href}>
                  <Link to={link.href} className="text-sm text-black hover:text-gray-700 transition-colors">
                    {link.label}
                  </Link>
                </li>)}
            </ul>
          ...
          <div>
            ...
            <a href="https://www.linkedin.com/in/ajay-pal-singh-rajput-5956b5181/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-black hover:text-gray-700 transition-colors" aria-label="LinkedIn Profile">
