        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <ul className="space-y-2">
              {links.map((link) => (
                <li key={link.href}>
                  <Link 
                    to={link.href}
                    className="text-sm text-health-light hover:text-white transition-colors"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <a 
              ...
              className="flex items-center gap-2 text-health-light hover:text-white transition-colors"
