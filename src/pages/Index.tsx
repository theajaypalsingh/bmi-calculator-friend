  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content="Calculate your BMI instantly with our free Body Mass Index calculator. Learn about healthy weight ranges and get personalized health recommendations."
        />
      </Helmet>
